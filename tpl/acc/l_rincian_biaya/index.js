app.controller('l_rincian_biaya', function ($scope, Data, $rootScope, $uibModal, Upload) {
    var control_link = "l_rincian_biaya";
    $scope.form = {};
...
//                console.log(response)
                window.open(response.data.base_url + "api/l_rincian_biaya/laporan?" + $.param(param), "_blank");
            });
        }
    };
});