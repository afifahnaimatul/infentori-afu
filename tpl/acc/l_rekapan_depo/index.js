app.controller('l_rekapan_depo', function ($scope, Data, $rootScope, $uibModal, Upload) {
    var control_link = "l_rekapan_depo";
    $scope.form = {};
...
//                console.log(response)
                window.open(response.data.base_url + "api/l_rekapan_depo/laporan?" + $.param(param), "_blank");
            });
        }
    };
});