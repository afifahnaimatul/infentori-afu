app.controller('l_rekapan_aliran_hutang', function ($scope, Data, $rootScope, $uibModal, Upload) {
    var control_link = "l_rekapan_aliran_hutang";
    $scope.form = {};
    ...
    $scope.view = function (is_export, is_print) {
        ...
        if (is_export == 0 && is_print == 0) {
            ...
            Data.get('site/base_url').then(function (response) {
                window.open(response.data.base_url + "api/l_rekapan_aliran_hutang/laporan?" + $.param(param), "_blank");
            });
        }
    }
});
