app.controller('l_harga_barang_dagang', function ($scope, Data, $rootScope, $uibModal, Upload) {
    var control_link = "l_harga_barang_dagang";
    $scope.form = {};
    ...
    $scope.view = function (is_export, is_print) {
        ...
        if (is_export == 0 && is_print == 0) {
            Data.get(control_link + '/laporanStokHarga', param).then(function (response) {
...
//                console.log(response)
                window.open(response.data.base_url + "api/l_harga_barang_dagang/laporanStokHarga?" + $.param(param), "_blank");
            });
        }
    };
