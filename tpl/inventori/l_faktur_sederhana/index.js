app.controller('l_faktur_sederhana', function ($scope, Data, $rootScope, $uibModal, Upload) {
    var control_link = "l_faktur_sederhana";
    $scope.form = {};
    $scope.form.tanggal = {
    ...
    $scope.cariBarang = function($query) {
        ...
        if ($query.length >= 3) {
            Data.get('l_faktur_sederhana/listbarang', {
                'nama': $query
...
//                console.log(response)
                window.open(response.data.base_url + "api/l_faktur_sederhana/laporan?" + $.param(param), "_blank");
            });
        }
    };
