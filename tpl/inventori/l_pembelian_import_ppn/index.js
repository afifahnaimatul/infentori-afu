app.controller('l_pembelian_import_ppn', function ($scope, Data, $rootScope, $uibModal, Upload) {
    var control_link = "l_pembelian_import_ppn";
    $scope.form = {};
...
//                console.log(response)
                window.open(response.data.base_url + "api/l_pembelian_import_ppn/laporan?" + $.param(param), "_blank");
            });
        }
    };
});
