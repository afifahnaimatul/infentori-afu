app.controller('l_retur_pembelian', function ($scope, Data, $rootScope, $uibModal, Upload) {
    var control_link = "l_retur_pembelian";
    $scope.form = {};
    // $scope.form.tanggal = {
    ...
    $scope.cariBarang = function ($query) {
        ...
        if ($query.length >= 3) {
            Data.get('l_retur_pembelian/listbarang', {
                'nama': $query
...
//                console.log(response)
                window.open(response.data.base_url + "api/l_retur_pembelian/laporan?" + $.param(param), "_blank");
            });
        }
    };
    ...
    $scope.exportData = function(clases) {
        ...
        saveAs(blob, "Laporan-Retur-Pembelian.xls");
    };
});
