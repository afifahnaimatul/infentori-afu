app.controller('l_rekap_pembelian_perbulan', function ($scope, Data, $rootScope, $uibModal, Upload) {
    var control_link = "l_rekap_pembelian_perbulan";
    $scope.form = {};
...
//                console.log(response)
                window.open(response.data.base_url + "api/l_rekap_pembelian_perbulan/laporan?" + $.param(param), "_blank");
            });
        }
    };
});