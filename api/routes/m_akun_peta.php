...
$app->get("/m_akun_peta/getPemetaanAkun", function($request, $response) {
...
$app->get('/m_akun_peta/index', function ($request, $response) {
    $params = $request->getParams();
    $db = $this->db;
...
$app->post('/m_akun_peta/save', function ($request, $response) {
